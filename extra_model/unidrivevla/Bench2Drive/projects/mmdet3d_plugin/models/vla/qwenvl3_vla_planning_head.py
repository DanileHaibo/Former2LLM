...
class QwenVL3APlanningHead(nn.Module):
    ...
    def forward_train(
        ...
        **kwargs,
        ...
        self.qwen3_vl_with_expert.qwen3_vl.visual.config._attn_implementation = "sdpa"
    ...
    def forward_test(
        ...
        **kwargs,
        ...
        head_device = device
        feature_maps_daf = [
            feat.to(device=head_device, dtype=head_dtype) if torch.is_tensor(feat) else feat
            for feat in feature_maps_daf
        ]
